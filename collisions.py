...
class Game:
    ...
    def __init__(self, width, height):
        ...
        #La meto en un grupo de sprites
        self.allSprites = pg.sprite.Group()
        self.allSprites.add(self.ball)   

        self.wallGroup = pg.sprite.Group()
        for i in range(random.randint(10, 26)):  # i para rango [10 - 26] crea de 10 a 26 ''w''      w = pared
    ...
    def star(self):
        ...
        while not game_over:
            ...
            for event in pg.event.get():    #imprescindible
                if event.type == QUIT:
                    game_over = True
